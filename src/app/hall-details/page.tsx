      ...
      <div className="mx-auto max-w-6xl space-y-8">
        <section className="rounded-3xl border border-white/10 bg-slate-900/70 p-8">
          ...
          <h1 className="mt-4 text-4xl font-semibold sm:text-5xl">
            Spacious venue designed for celebrations and business events.
          </h1>
          <p className="mt-6 max-w-3xl text-lg text-slate-300">
            Enjoy elegant interiors, flexible seating, modern amenities, and
            seamless service for weddings, receptions, birthdays, and corporate
            functions.
          </p>
        </section>
